...
For usage see: https://pythonhosted.org/python-gnupg/ @ test harness

Copyright (C) 2008-2020 Vinay Sajip. All rights reserved. 

-- Downloaded from    https://pypi.org/project/python-gnupg/#files
-- and extracted from python-gnupg-0.4.6.tar.gz for python.3.8
